            ...
            <button key={i} onClick={() => setCurrent(i)} className="featured-dot-btn">
              ...
              <div
                ...
                style={{
                  ...
                  background: i === current ? "#a2e773" : "rgba(var(--fg-rgb),0.3)",
                }}
              />
            </button>
          ))}
  ...
  return (
    ...
    >
      ...
      <img
        ...
        style={{
          filter: hovered
            ? "var(--projectBrightness1)"
            : "var(--projectBrightness2)",
        }}
      />
...
export default function ProjectsPage() {
  ...
  return (
    <div className="projects-page-root inner-page-root">
      {/* <CustomCursor /> */}
      <InnerNav />
          ...
          {FILTERS.map((f) => (
            <button
              ...
              style={{
                ...
                border: activeFilter === f ? "1px solid var(--primary)" : "1px solid rgba(var(--fg-rgb),0.35)",
                color: activeFilter === f ? "var(--altColor)" : "var(--darkGray)",
              }}
            >
              {f}
            </button>
